...
#ifndef _PURCHASINGMANAGERNODEMAND_H
#define _PURCHASINGMANAGERNODEMAND_H

#include "PurchasingManager.h"

class PurchasingManagerNoDemand : public PurchasingManager {
  protected:
    void send_demand_requests__D();

  public:
    PurchasingManagerNoDemand();
};
